...
* [Синтаксис и семантика](syntax-and-semantics.md)
    ...
    * [Универсальный синтаксис вызова функций](ufcs.md)
    ...
    * [Преобразования при разыменовании](deref-coercions.md)
    * [Макросы](macros.md)
...
* [Эффективное использование Rust](effective-rust.md)
    ...
    * [Интерфейс внешних функций](ffi.md)
...
* [Нестабильные возможности Rust](nightly-rust.md)
    ...
    * [Элементы языка](lang-items.md)
    * [Продвинутое руководство по компоновке](advanced-linking.md)
